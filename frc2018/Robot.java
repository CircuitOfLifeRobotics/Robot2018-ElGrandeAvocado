...
//		Intake.getInstance().zeroLift();
	...
	public void teleopPeriodic() {
			...
			SmartDashboard.putNumber("Current Encoder", Intake.getInstance().getLiftMotorEncoder());
			SmartDashboard.putNumber("Current Setpoint", Intake.getInstance().getCurrentSetpoint());

//			
//			System.out.println(Intake.getInstance().getCurrentSetpoint());
//			System.out.println("E" + Intake.getInstance().getLiftMotorEncoder());

			
//			if(!Intake.getInstance().isAtSetpoint()) {
//				
//				System.out.println("No");
//				System.out.println("Is: " + Intake.getInstance().getLiftMotorEncoder());
//				System.out.println("Should: " + Intake.getInstance().getCurrentSetpoint());
//			}
